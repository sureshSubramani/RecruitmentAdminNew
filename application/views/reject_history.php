                                            ...
                                            <?php if(!empty($STAFF)){ 
											 ...
											 <tr>												
												...
												<td>
                                                    ...
                                                    <button type="button" id="button" class="btn btn-sm btn-success" onClick="getShortlist(<?php echo $value->personal_id;?>)"><i class='fa fa-user'></i> Select</button>  
                                                    <button type="button" id="button" class="btn btn-sm btn-danger" onClick="setReject(<?php echo $value->personal_id;?>)">Reject <i class='fa fa-user'></i></button>  
