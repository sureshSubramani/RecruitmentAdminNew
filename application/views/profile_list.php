										...
										<form action="" method="get">
                                            <?php if(!empty($STAFF)){ 
											 ...
											 <tr>												
                                                ...
                                                <?php if($value->reg_status == 1){ ?>
												<td>
                                                    <?php if($value->profile_status == 0){  ?>

                                                    <button type="button" id="button" class="badge badge-success" onClick="getShortlist(<?php echo $value->personal_id;?>)"><i class='fa fa-user'></i> Select</button>  
                                                    <button type="button" id="button" class="badge badge-danger" onClick="setReject(<?php echo $value->personal_id;?>)">Reject <i class='fa fa-user'></i></button>  

                                                    <?php } ?>
                                                     <!-- <?php if($value->profile_status == 1){  ?>
                                                     <button type="button" id="button" class="btn   btn-sm btn-danger"  onClick="getShortlist(<?php echo $value->personal_id;?>)">
                                                        Reject
                                                    </button>   
                                                    <?php  }else{?>
                                                ...
                                                <?php }?>
                                                <?php if($value->reg_status == 0){ ?>
												<td style='width:120px'><span>-</span> </td>
                                                <?php }else{ ?>
                                                    <td style='width:120px'>
                                                    <button type='button' class='btn btn-sm btn-info icon-top' name='select_status' data-toggle="modal" 
													...
													<a href="<?php echo base_url() ?>print_pdf/pdf_download?&personal_id=<?php echo $value->personal_id;?>"
                                                        class='btn btn-sm btn-danger icon-top' id='pdf_download' target='top'><i class="fa fa-download" aria-hidden="true"></i></a>
...
function setReject(personal_id){

        var isTrue = confirm("Are you sure to confirm?");
        if(isTrue){
            $.ajax({
                url:"<?php echo base_url(); ?>profile_list/setReject?&personal_id="+personal_id,                
                type: 'get',
                dataType: 'json',
                //timeout:5000,
                success: function(reponse){ 
